...
const DemoMenu = ({ classes }) => (
  <div className={classes.root}>
    ...
    <a href={ROUTES.demo.editor} className={classes.link}>
      Editor
    </a>
    ...
    <a href={ROUTES.demo.palette} className={classes.link}>
      Palette
    </a>
    <a href={ROUTES.demo.snacks} className={classes.link}>
      Snacks
    </a>
    <a href={ROUTES.demo.widgets} className={classes.link}>
      Widgets
    </a>
  </div>
)
