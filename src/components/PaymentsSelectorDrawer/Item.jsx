...
const styles = theme => ({
  ...
  title: {
    display: ({ mode }) => (mode === 'category' ? 'none' : 'table-cell'),
    width: ({ mode }) => (mode === 'title' ? 154 + 180 : 154),
    minWidth: ({ mode }) => (mode === 'title' ? 154 + 180 : 154),
    maxWidth: ({ mode }) => (mode === 'title' ? 154 + 180 : 154),
    whiteSpace: 'nowrap',
    textOverflow: 'ellipsis',
    overflow: 'hidden',
  ...
  category: {
    display: ({ mode }) => (mode === 'title' ? 'none' : 'table-cell'),
    width: ({ mode }) => (mode === 'category' ? 180 + 154 : 180),
    minWidth: ({ mode }) => (mode === 'category' ? 180 + 154 : 180),
    maxWidth: ({ mode }) => (mode === 'category' ? 180 + 154 : 180),
    whiteSpace: 'nowrap',
    textOverflow: 'ellipsis',
    overflow: 'hidden',
    paddingLeft: 10,
