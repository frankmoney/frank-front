...
export default class Autosuggest extends Component {
  ...
  handleInputFocus = event => {
    ...
    const { value, onFocus } = inputProps
  ...
  handleInputKeyDown = (event, data) => {
    ...
    const { value, onKeyDown } = inputProps
  ...
  handleInputChange = event => {
    const { alwaysRenderSuggestions, highlightFirstSuggestion } = this.props
    const shouldRenderSuggestions = alwaysRenderSuggestions
      ? alwaysTrue
      : this.props.shouldRenderSuggestions
    ...
    //
    if (shouldRender) {
      this.props.onSuggestionsFetchRequested({ value, reason: 'input-changed' })
    } else {
      this.onSuggestionsClearRequested()
    }
  }
