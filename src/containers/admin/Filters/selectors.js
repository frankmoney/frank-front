...
export const aggregateDateMin = get('aggregated', 'dateMin')
export const aggregateSumMin = get('aggregated', 'sumMin')
export const aggregateSumMax = get('aggregated', 'sumMax')
